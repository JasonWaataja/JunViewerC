...
static const SECTION union { const guint8 data[1092]; const double alignment; void * const ptr;}  junviewer_resource_data = { {
  ...
  0x44, 0x04, 0x00, 0x00, 0x2f, 0x00, 0x00, 0x00, 
